...
<!--
          ...
          <li class="nav-item dropdown text-success" style="width: 120px;">
            ...
            <ul class="dropdown-menu bg-dark" aria-labelledby="dropdown05">
             <li><a class="dropdown-item text-success" href="{{ route('show.Supplier') }}">Suppliers List</a></li>
              <li><a class="dropdown-item text-success" href="{{ route('show.Supplierdeliver') }}">Supplier Deliver</a></li>
              ...
              <li><a class="dropdown-item text-success" href="{{ route('show.payment') }}">Total Payment</a></li>
            </ul>
          </li>
           ...
           <li class="nav-item dropdown text-success" style="width: 125px;">
             ...
             <ul class="dropdown-menu bg-dark" aria-labelledby="dropdown05">
               <li><a class="dropdown-item text-success" href="{{ route('show.warehouse') }}">Warehouse Entry </a></li>
               
               <li><a class="dropdown-item text-success" href="{{ route('show.warehousenewload') }}">Warehouse Update</a></li>
               
               <li><a class="dropdown-item text-success" href="{{ route('show.warehouseupdateloadnew') }}">Product Received</a></li>
          ...
          <li class="nav-item dropdown text-success" style="width: 90px;">
             ...
             <ul class="dropdown-menu bg-dark" aria-labelledby="dropdown05">
               <li><a class="dropdown-item text-success" href="{{ route('show.product') }}">Market Stock</a></li>
               <li><a class="dropdown-item text-success" href="{{ route('show.newstock') }}">Loaded Stock</a></li>     
               <li><a class="dropdown-item text-success" href="{{ route('show.productstatis') }}">Product Stat</a></li>
                </ul>
          ...
          <li class="nav-item dropdown text-success" style="width: 90px;">
            ...
            <ul class="dropdown-menu bg-dark" aria-labelledby="dropdown05">
              ...
              <li><a class="dropdown-item text-success" href="{{ route('show.salestatistic') }}">Sale statistics</a></li>
               <li><a class="dropdown-item text-success" href="{{ route('show.customerstatistic') }}">Users statistics</a></li>
        ...
        <ul class="dropdown-menu text-small shadow " aria-labelledby="dropdownUser2">
          <li><a class="dropdown-item" href="{{ route('show.newuser') }}">Users</a></li>
