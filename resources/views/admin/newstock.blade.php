...
@section("title") {{ 'NewStock' }} @endsection
...
$(document).ready(function(){    
    ...
    function showAllnewstock(){
        _tables("#shownewstock",'{{ route('fetch.newstock') }}','List of newstock Information'); 
    }
  });
...
$(document).ready(function(){    
    ...
    function showAllnewstock(){
        _tables("#shownewstock",'{{ route('fetch.newstock') }}','List of Warehouse Information'); 
    }
  });
